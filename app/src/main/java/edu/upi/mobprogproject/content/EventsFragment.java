...
import edu.upi.mobprogproject.adapter.EventAdapter;
...
public class EventsFragment extends Fragment {
    ...
    static ArrayList<EventsList> agenda;
    private View v;
    ...
    private void setRecView() {
        ...
        /*
        agenda.add(new EventsList("penting", "12", "Jan", "Free Android",
                "Sabuga", "12.00-13.00", "Pak RT"));
        agenda.add(new EventsList("terdekat", "13", "Feb", "Kopdar Moprog",
                "Monju", "01.00-03.00", "Pak RW"));
        agenda.add(new EventsList("terdekat", "14", "Mar", "Hackaton 7M",
                "Dago", "23.12-1.23", "Kades"));
        agenda.add(new EventsList("terdekat", "15", "Apr", "Lomba ML",
                "Cibiru", "10.00-13.00", "Pemkot"));
        agenda.add(new EventsList("terdekat", "16", "Mei", "Lomba Balap Kerupuk",
                "UPI", "09.00-10.00", "Kemakom"));
        agenda.add(new EventsList("terdekat", "17", "Jun", "Lomba Koding",
                "GEEK", "11.00-12.00", "UPI"));
        */
        recyclerView = v.findViewById(R.id.rcEvent);
        adapter = new EventAdapter(activity, agenda);
...
//        recyclerView.addItemDecoration(dividerItemDecoration);
    ...
    public ArrayList<EventsList> setData(DbEvents dbe, DbUsers dbu) {
        ArrayList<EventsList> ag = new ArrayList<>();
    ...
    //public static ArrayList<EventsList> getAgenda() {
    //    return agenda;
    //}
    @Override
